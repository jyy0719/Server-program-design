			...
			<div class="container2">
				<div class="subcontainer">
					...
					<div class="box_right">
						<table class="loc">
							<tr>
								<td class=Tright><img src="../image/userpic.PNG" style="width: 30px; height: 30px;">&nbsp;&nbsp;${member.user_email}</td>
							</tr>
							<tr>
								<td class=Tright><img src="../image/nickpic.PNG" style="width: 30px; height: 30px;">&nbsp;&nbsp;${member.user_nick}</td>
							</tr>
						</table>
					</div>
				</div>
